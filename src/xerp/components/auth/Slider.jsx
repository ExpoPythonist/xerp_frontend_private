...
const items = [
  {
    ...
    altText: 'xERP Apps',
    title: 'xERP Apps',
    caption: 'xERP provides many solutions for your business and living. Choose our apps to get the ultimate software experience.'
  },
  {
    ...
    const slides = items.map((item, i) => {
      return (
        <CarouselItem
          ...
          key={i}
        >
          <img height={600} src={item.src} alt={item.altText} />
